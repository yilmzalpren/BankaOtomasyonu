 ...
 * @author YILMAZ
 */
public class BakiyeyiDigerHesabaAktar extends javax.swing.JFrame {
    public static User currentUser = null ; 
    public static String bakiye = null ;
    /**
     * Creates new form BakiyeyiDigerHesabaAktar
     */
    public BakiyeyiDigerHesabaAktar() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("KALAN BAKİYENİN AKTARILACAĞI HESABI SEÇİN");
    ...
    private void jVadesizTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jVadesizTableMousePressed
        ...
        if(index!=-1){
           ...
           ((Musteri)BakiyeyiDigerHesabaAktar.currentUser).vadesizHesapBakiye(hesapNo, Double.valueOf(bakiye), true);
     ...
     */
    public static void mainBakiyeDigerHesabaAktar(User currentUser,String bakiye) {
        BakiyeyiDigerHesabaAktar.currentUser = currentUser;
        BakiyeyiDigerHesabaAktar.bakiye = bakiye ; 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BakiyeyiDigerHesabaAktar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BakiyeyiDigerHesabaAktar().setVisible(true);
            }
        });
    }
