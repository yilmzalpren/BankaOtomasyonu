 ...
 * @author YILMAZ
 */
public class ParaTransfer2 extends javax.swing.JFrame {
    public static User currentUser ; 
    public static String vadesizHesapNo;
    public static String vadesizBakiye;
    /**
     * Creates new form ParaTransfer2
     */
        ...
        try{
            ...
            if(vadeliHesapPara <=0){
                ...
                if(!((((Musteri)currentUser).vadesizHesapBakiye(vadesizHesapNo, vadeliHesapPara, false)))){
                    ...
                    this.dispose();
                    // 3. asama
                    if(((Musteri)currentUser).baskaMusteriVarmi())
                        ParaTransfer3.mainParaTransfer3(currentUser, vadesizHesapNo, vadesizBakiye, vadeliHesapPara);
                    else{
                        // parayi geri ver
                        ((Musteri)currentUser).vadesizHesapBakiye(vadesizHesapNo, vadeliHesapPara, true); 
                        ParaTransferAraFrame.mainParaTransferAraFrame(currentUser);
                        javax.swing.JOptionPane.showMessageDialog(null,"SİZİN DISINIZDA BANKAMIZIN MUSTERİ YOK :(\nISTERSENIZ BU"
                                + "PROJEYE 100 VEREREK BANKAMIZA DESTEK OLABILIRSINIZ :)");
                    }
                }
            }
     ...
     */
    public static void mainParaTransfer2(User currentUser,String vadesizHesapNo,String vadesizBakiye) {
        ParaTransfer2.currentUser = currentUser;
        ParaTransfer2.vadesizHesapNo = vadesizHesapNo;
        ParaTransfer2.vadesizBakiye = vadesizBakiye;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ParaTransfer2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ParaTransfer2().setVisible(true);
            }
        });
    }
