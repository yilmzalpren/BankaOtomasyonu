 ...
 * @author YILMAZ
 */
public class YatirimHesapSil extends javax.swing.JFrame {
    public static User currentUser ; 
    public static String yatirimHesapNo;
    public static String yatirimBakiye;
    public static int flag ; 
    /**
     * Creates new form YatirimHesapSil
     */
    public YatirimHesapSil() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jYaziLabel.setText("PARANIN AKTARILACAGI HESABI SECİNİZ");
    ...
    private void jVadesizTableMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jVadesizTableMousePressed
       ...
       int index = jVadesizTable.getSelectedRow();
        if(index!=-1){
           ...
           this.setVisible(false);
           this.dispose();
           ((Musteri)currentUser).vadesizHesapBakiye(hesapNo, Double.valueOf(yatirimBakiye), true);
           //((Musteri)currentUser).vadeliHesapSil(vadeliHesap.getHesapNo());
           ((Musteri)currentUser).yatirimHesapSil(yatirimHesapNo, flag);
     ...
     */
    public static void mainYatirimHesapSil(User currentUser,String yatirimHesapNo,String yatirimBakiye,int flag) {
        YatirimHesapSil.currentUser = currentUser;
        YatirimHesapSil.yatirimHesapNo = yatirimHesapNo;
        YatirimHesapSil.yatirimBakiye = yatirimBakiye ; 
        YatirimHesapSil.flag = flag ; 
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(YatirimHesapSil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new YatirimHesapSil().setVisible(true);
            }
        });
    }
