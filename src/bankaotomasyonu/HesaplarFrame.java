 ...
 * @author YILMAZ
 */
public class HesaplarFrame extends javax.swing.JFrame {
    public static User currentUser = null ; 
    /**
     * Creates new form HesaplarFrame
     */
    public HesaplarFrame() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jBireyselLabel = new javax.swing.JLabel();
        jSeparator1 = new javax.swing.JSeparator();
        jTicariLabel = new javax.swing.JLabel();
        ...
        jBireyselLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/bireysel.png"))); // NOI18N
        jBireyselLabel.setText("BİREYSEL HESAPLARIM");
        jBireyselLabel.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                jBireyselLabelMousePressed(evt);
            }
        });
        ...
        jTicariLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/ticari.png"))); // NOI18N
        jTicariLabel.setText("TİCARİ HESAPLARIM");

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel1.setText("HESAPLARIM");
        ...
        jArkaPanelLayout.setHorizontalGroup(
            ...
            .addGroup(jArkaPanelLayout.createSequentialGroup()
                .addGroup(jArkaPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jArkaPanelLayout.createSequentialGroup()
                        .addGap(63, 63, 63)
                        .addComponent(jBireyselLabel)
                        .addGap(18, 18, 18)
                        .addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 12, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(jTicariLabel)
    ...
    private void jBireyselLabelMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jBireyselLabelMousePressed
        // TODO add your handling code here:
        this.setVisible(false);
        this.dispose();
        BireyselHesaplarFrame.mainBireyselHesaplarFrame(currentUser);
    }//GEN-LAST:event_jBireyselLabelMousePressed

    /**
     * @param args the command line arguments
     */
    public static void mainHesaplarFrame(User currentUser) {
        HesaplarFrame.currentUser = currentUser;
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HesaplarFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new HesaplarFrame().setVisible(true);
            }
        });
    }
